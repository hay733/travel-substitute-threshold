  ...
  return (
    <TableContainer component={Paper}>
      <Table className={classes.table} aria-label="simple table">
        <TableHead>
          <TableRow>
            <TableCell className={classes.tableCell}><h2><b>Constructs</b></h2></TableCell>
            <TableCell align="right" className={classes.tableCell}><h2>Degree Required</h2></TableCell>
            <TableCell align="right" className={classes.tableCell}><h2>Recommendation</h2></TableCell>
          </TableRow>
        </TableHead>
        <TableBody>
          {rows.map((row) => (
            <TableRow key={row.name}>
              ...
              <TableCell id='degree-buttons' align="right" className={classes.tableCell}>{row.degree}</TableCell>
