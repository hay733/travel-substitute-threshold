...
import EngagementCopresenceSSAQuestions from '../constructQuestions/EngagementCopresenceSSA'
 ...
 */
class QuestionsEngagementCopresenceSSA extends React.Component {
    constructor(props) {
        super(props);
    }
    state = {
        ...
        return (
            <div>
                ...
                <body className={classes.container} style={{ fontFamily: "Open Sans, sans-serif"  }}>
                    ...
                    <EngagementCopresenceSSAQuestions onClick={this.openModal}/>
                    <br></br><br></br>

                    <Button className={classes.submitButton} href="/questions-rapport_trust">
                        Back
                    </Button>
...
export default withStyles(styles)(QuestionsEngagementCopresenceSSA);