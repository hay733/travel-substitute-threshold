...
import PerformanceQuestions from '../constructQuestions/Performance'
 ...
 */
class QuestionsPerformance extends React.Component {
    constructor(props) {
        super(props);
    }
    state = {
        ...
        return (
            <div>
                ...
                <body className={classes.container} style={{ fontFamily: "Open Sans, sans-serif"  }}>
                    <br></br><br></br>
                    <Stepper nonLinear activeStep={2} alternativeLabel className={classes.stepper}>
                        <Step>
                    ...
                    <PerformanceQuestions onClick={this.openModal}/>
                    <br></br><br></br>
                    ...
                    <Button className={classes.submitButton} style={{float: 'right'}} href="/questions-rapport_trust">
                        Next
                    </Button>
                    <br></br><br></br><br></br>
                </body>
...
export default withStyles(styles)(QuestionsPerformance);